...
!        DO IP = 1,NPOIN3 ! LOOPING THROUGH ALL THE MESH NODES
! IF ( THE DEPTH IS  LESS THAN -1050 M) THEN
!          IF (MESH3D%Z%R(IP).LE.-1050.D0) THEN
!   THE TRACER 1 OF THE NODE IP IS 4.5°C
!            TA%ADR(1)%P%R(IP) = 4.5D0
! OTHERWISE
!          ELSEIF(MESH3D%Z%R(IP).GT.-1050.D0.AND.MESH3D%Z%R(IP).LE.-500.D0) THEN
!   THE TRACER 1 OF THE NODE IP IS PROFILE 1
!            TA%ADR(1)%P%R(IP)=(MESH3D%Z%R(IP)+1625.D0)/125.D0
!          ELSEIF(MESH3D%Z%R(IP).GT.-500.D0.AND.MESH3D%Z%R(IP).LE.-50.D0) THEN
!   THE TRACER 1 OF THE NODE IP IS PROFILE 2
!            TA%ADR(1)%P%R(IP)=(MESH3D%Z%R(IP)+713.1579D0)/23.6842D0
!          ELSEIF(MESH3D%Z%R(IP).GT.-50.D0) THEN
!   THE TRACER 1 OF THE NODE IP IS 28°C
!            TA%ADR(1)%P%R(IP)=28.D0
!          ENDIF      
!        ENDDO

!        DO IP = 1,NPOIN3 ! LOOPING THROUGH ALL THE MESH NODES
! IF ( THE DEPTH IS  LESS THAN -500 M) THEN
!          IF (MESH3D%Z%R(IP).LE.-500.D0) THEN
!   THE TRACER 2 OF THE NODE IP IS 34.5
!            TA%ADR(2)%P%R(IP) = 34.5D0
! OTHERWISE
!          ELSEIF(MESH3D%Z%R(IP).GT.-500.D0.AND.MESH3D%Z%R(IP).LE.-200.D0) THEN
!   THE TRACER 2 OF THE NODE IP IS PROFILE 1
!            TA%ADR(2)%P%R(IP)=(MESH3D%Z%R(IP)+8780.D0)/240.D0
!          ELSEIF(MESH3D%Z%R(IP).GT.-200.D0.AND.MESH3D%Z%R(IP).LE.-50.D0) THEN
!   THE TRACER 2 OF THE NODE IP IS PROFILE 2
!            TA%ADR(2)%P%R(IP)=(8050.D0-MESH3D%Z%R(IP))/230.7692D0
!          ELSEIF(MESH3D%Z%R(IP).GT.-50.D0) THEN
!   THE TRACER 2 OF THE NODE IP IS 35.1
!            TA%ADR(2)%P%R(IP)=35.1D0
!          ENDIF      
!        ENDDO
