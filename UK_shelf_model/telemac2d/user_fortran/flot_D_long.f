...
!     Release every 10s time step for 360 from 2 days into run
!     dT=10 secs STATION D
      IF(LT.LE.17640.AND.(1*(LT/1).EQ.LT.AND.LT.GE.17280)) THEN
       CALL ADD_PARTICLE(23209.2D0,51456.7D0,0.0D0,LT,NFLOT,
...
!
     ...
     &                      YFLOT(IFLOT),ZFLOT(IFLOT),1
            ENDDO
          ENDIF
200       FORMAT(A,F16.4,A,A,I4,A,F16.4)
