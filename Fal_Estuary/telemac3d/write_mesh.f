...
!       GET X COORDINATE
        ...
        IF(IERR.NE.0) THEN
          IF (LNG.EQ.1)
     &    WRITE(LU,*) 'WRITE_MESH : ERREUR LORS DE LA LECTURE DE X'
          IF (LNG.EQ.2)
...
!       GET Y COORDINATE
        ...
        IF(IERR.NE.0) THEN
          IF (LNG.EQ.1)
     &    WRITE(LU,*) 'WRITE_MESH : ERREUR LORS DE LA LECTURE DE Y'
          IF (LNG.EQ.2)
...
!
      IF(PRESENT(NGEO)) THEN
        IF(NCSIZE.LE.1.AND.GEOFORMAT.EQ.FFORMAT) THEN
